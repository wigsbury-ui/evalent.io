...
/* ââ Sort comparator ââââââââââââââââââââââââââââââââââââââââââââ */
...
/* ââ Sortable header component ââââââââââââââââââââââââââââââââââ */
function SortHeader({
  label,
  sortKey,
  currentSort,
  ...
  const handleExport = async (format: "xlsx" | "csv" | "pdf") => {
    ...
    try {
      if (format === "csv") {
        ...
        doc.text(
          `Student Report â Exported ${new Date().toLocaleDateString("en-GB")}`,
          14,
          22
        );
        ...
        for (let i = 1; i <= pageCount; i++) {
          ...
          doc.text(
            `Page ${i} of ${pageCount} â Generated by Evalent`,
            14,
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-4 mt-4">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span className="ml-4 text-gray-400">
                    {startIndex + 1}â{Math.min(startIndex + rowsPerPage, sorted.length)} of{" "}
                    {sorted.length}
                  </span>
                </div>
