...
export function TopBar({ used, cap, tier, hasGradeConfigs, hasAssessors, hasStudents }: TopBarProps) {
  ...
  return (
    <div style={{ backgroundColor: bg, borderBottom: '1px solid ' + borderColor, flexShrink: 0 }}><div style={{ display: 'flex', alignItems: 'center', gap: 24, padding: '0 24px', height: 44, maxWidth: 1400, marginLeft: 'auto', marginRight: 'auto' }}>
      {isTrial && (
