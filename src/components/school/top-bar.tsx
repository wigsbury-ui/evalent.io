...
export function TopBar({ used, cap, tier, hasGradeConfigs, hasAssessors, hasStudents }: TopBarProps) {
  ...
  return (
    <div style={{ backgroundColor: bg, borderBottom: '1px solid ' + borderColor }}><div style={{ display: 'flex', alignItems: 'center', gap: 24, height: 44, paddingLeft: 80, paddingRight: 24 }}>
      {isTrial && (
