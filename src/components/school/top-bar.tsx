...
export function TopBar({ used, cap, tier, hasGradeConfigs, hasAssessors, hasStudents }: TopBarProps) {
  ...
  return (
    <div style={{ backgroundColor: bg, borderBottom: '1px solid ' + borderColor }}><div style={{ display: 'flex', alignItems: 'center', gap: 24, height: 44, maxWidth: 1400, margin: '0 auto', padding: '0 24px' }}>
      {isTrial && (
