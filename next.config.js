...
const securityHeaders = [
  ...
  { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://avatars.githubusercontent.com https://*.vimeocdn.com https://*.paddle.com",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.paddle.com",
      "frame-src 'self' https://player.vimeo.com https://form.jotform.com https://*.paddle.com",
